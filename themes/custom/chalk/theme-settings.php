...
function chalk_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  global $theme_path;

  $styleguide_path = base_path() . drupal_get_path('theme', 'chalk') .'/styleguide/index.html';
  $form['chalk_styleguide'] = array(
    '#title'         => '&#9733; ' . t('Styleguide'),
  ...
  $form['chalk_typekit'] = array(
    '#type' => 'fieldset',
    '#title'         => '&#3845; ' . t('Typekit'),
  );

  $form['chalk_typekit']['typekit_id'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Typekit ID'),
