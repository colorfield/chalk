...
function overlayshadow_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  global $theme_path;

  $styleguide_path = base_path() . drupal_get_path('theme', 'overlayshadow') .'/styleguide/index.html';
  $form['overlayshadow_styleguide'] = array(
    '#title'         => '&#9733; ' . t('Styleguide'),
  ...
  $form['overlayshadow_typekit'] = array(
    '#type' => 'fieldset',
    '#title'         => '&#3845; ' . t('Typekit'),
  );

  $form['overlayshadow_typekit']['typekit_id'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Typekit ID'),
